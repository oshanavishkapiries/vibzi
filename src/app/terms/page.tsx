      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <ul className="list-disc pl-6 mt-2 space-y-2">
            ...
            <li>
              App Distributors have no warranty obligation whatsoever with
              respect to the App
            </li>
          </ul>
        </div>
  ...
  },
  {
    ...
    content: (
      <div>
        ...
        <p>
          Please be advised the Services are hosted in Singapore. If you access
          ...
          Singapore, and you expressly consent to have your data transferred to
          and processed in Singapore.
        </p>
      </div>
    ),
  },
    ...
    content: (
      <div>
        <p>
          ...
          of Sri Lanka. Voyage Vibes (PVT) LTD and yourself irrevocably consent
          that the courts of Sri Lanka shall have exclusive jurisdiction to
